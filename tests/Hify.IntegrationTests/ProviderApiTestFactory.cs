...
/// <summary>
/// 供应商/模型 HTTP 集成测试用工厂：把数据库指向测试 PG（连接串读 HIFY_TEST_DB，默认本地 5432），
/// 注入凭证加密密钥，并关闭周期探活避免后台噪声。
/// </summary>
public sealed class ProviderApiTestFactory : WebApplicationFactory<Program>
{
